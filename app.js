...
const CONFIG_AIP02 = {
    "AIP_PB": {
        ...
        msrTop: [
            { id: "MSR 104", pasillos: ["101", "102", "103", "104"] },
            { id: "MSR 102", pasillos: ["105", "106", "107", "108"] }
        ],
        msrBottom: [
            { id: "MSR 103", pasillos: ["201", "202", "203", "204"] },
            { id: "MSR 101", pasillos: ["205", "206", "207", "208"] }
        ]
    },
    "AIP_P1": {
        ...
        msrTop: [
            { id: "MSR 201", pasillos: ["301", "302", "303", "304"] },
            { id: "MSR 203", pasillos: ["305", "306", "307", "308"] }
        ],
        msrBottom: [
            { id: "MSR 202", pasillos: ["401", "402", "403", "404"] },
            { id: "MSR 204", pasillos: ["405", "406", "407", "408"] }
        ]
    },
    "AIP_P2": {
        ...
        msrTop: [
            { id: "MSR 304", pasillos: ["501", "502", "503", "504"] },
            { id: "MSR 302", pasillos: ["505", "506", "507", "508"] }
        ],
        msrBottom: [
            { id: "MSR 303", pasillos: ["601", "602", "603", "604"] },
            { id: "MSR 301", pasillos: ["605", "606", "607", "608"] }
        ]
    }
};
